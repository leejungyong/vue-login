    ...
    <div class="clearFix el=menu--dark">
        <ul class="el-menu menu-horizontal el-menu--dark el-menu--horizontal header-nav">
            <router-link to="/" class="el-menu-item logo" exact tag="li">
             ...
             <router-link to="/project" class="el-menu-item " exact tag="li">
                <i class="fa fa-home"></i>我的项目
            </router-link>
             <router-link to="/workbench" class="el-menu-item " exact tag="li">
                  <i class="fa fa-code"></i>工作台
            </router-link>
             <router-link to="/doc" class="el-menu-item " exact tag="li">
